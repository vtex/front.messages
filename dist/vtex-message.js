    ...
    */
    ...
    Message.prototype.show = function(options) {
      ...
      if (typeof options === 'object' && (options.complete != null) && typeof options.complete === 'function') {
        ...
        this.visible = true;
        if (typeof options === 'object' && (options.timeout != null) && options.timeout !== 0) {
          return window.setTimeout(function() {
            return _this.hide(options);
          }, options.timeout);
        }
      }
    };
    ...
    VtexMessages = (function() {
      ...
      */
      ...
      function VtexMessages(options) {
        ...
        this.deduplicateMessages = __bind(this.deduplicateMessages, this);
      ...
      */
      ...
      VtexMessages.prototype.addMessage = function(message, show) {
        var messageObj;
        if (show == null) {
          show = false;
        }
        ...
        if (show !== false) {
          return messageObj.show(message);
        }
      };
      ...
      */
      ...
      VtexMessages.prototype.removeMessage = function(messageProperty) {
      ...
      VtexMessages.prototype.hideAllMessages = function(usingModal) {
        var _this = this;
        return _.each(this.messagesArray, function(message) {
          if (message.visible) {
      ...
      VtexMessages.prototype.startListeners = function() {
        ...
        if (window) {
          $(window).on("vtex.message.addMessage", function(evt, message, show) {
            return _this.addMessage(message, show != null ? show : true);
          });
          return $(window).on("vtex.message.clearMessage", function(evt, usingModal) {
            if (usingModal == null) {
              usingModal = false;
            }
            return _this.hideAllMessages(usingModal);
          });
        }
      };
